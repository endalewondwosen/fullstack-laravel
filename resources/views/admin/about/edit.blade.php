        ...
        <div class="card-body">
            <form action="{{ url('update/about/'.$about->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="short_desc"  id="" cols="30" rows="3" class="form-control" placeholder="">
                        {{ $about->short_desc }}</textarea>          
                    @error('short_desc')
                        <span class="text-danger">{{ $message }} !</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <textarea name="long_desc"  id="" cols="30" rows="3" class="form-control" placeholder="">
                        {{ $about->long_desc }}</textarea>          
                    @error('long_desc')
                        <span class="text-danger">{{ $message }} !</span>
                    @enderror
                </div>
